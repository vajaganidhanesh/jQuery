$(document).ready(function () {
  ...
  $.each(products, function (index, product) {
    ...
    $productDiv.append($("<h2>").text(product.title));
    $productDiv.append($("<p>").text("Price: $" + product.price));
  ...
  $("#addProductForm").submit(function (event) {
    ...
    var $productDiv = $("<div>").addClass("product");
    $productDiv.append($("<h2>").text(newProduct.title));
    $productDiv.append($("<p>").text("Price: $" + newProduct.price));
    $productDiv.append($("<p>").text("Category: " + newProduct.category));
    $productDiv.append($("<img>").attr("src", newProduct.image));
    $("#productList").append($productDiv);
  ...
  $(".product").click(function () {
    ...
    $(this).find("h2").text(product.title);
  });

  // Delete (Remove) Operation
  $(".product").hover(
    function () {
      $(this).append($("<button>").text("Delete").addClass("deleteButton"));
    },
    function () {
